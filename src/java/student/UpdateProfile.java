...
public class UpdateProfile extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
     ...
     String user=session.getAttribute("user").toString(); //cont=9098765438&mail=velly%40gmail.com 
    ...
    response.sendRedirect("StuProfile.jsp?msg=Profile Updated Successfully"); 
     } 
        } 
        catch(Exception e) 
        { 
