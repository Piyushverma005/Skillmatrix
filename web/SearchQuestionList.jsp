<%-- 
    Document   : SearchQuestionList
    Created on : 22 Jul, 2025, 1:21:14 AM
    Author     : Piyush verma
--%>
...
.navbar 
        { 
         display: inline-block;          border: 3px solid white;         margin-left: 0%;          margin-top: 25px;          border-radius: 5px; 
        } 
        .navbar li{             display: inline-block; 
        } 
        .navbar li a{             color: red;             font-size:23px;             padding: 15px;             text-decoration: none; 
        } 
.navbar li a:hover{ 
            
           color: black;            font-size:23px;            padding:15px;            text-decoration: none;  
       } 
...
<li><a href="StudentList.jsp">Student List</a> 
    ...
    <center> 
        <br><br> 
  <div 
style="width:1200px;height:450px;backgroundcolor:lightgrey;border:2px solid red;">  
...
<% 
String qid=request.getParameter("qid"); DBCon db=new DBCon(); db.pstmt=db.con.prepareStatement("select * from ques_mstr where qid=?"); db.pstmt.setString(1, qid); db.rst=db.pstmt.executeQuery(); if(db.rst.next()) 
{ 
out.println("<tr><td width=300>Enter Question ID</td><td><input type=number value='"+db.rst.getString(1)+"' name=qid></td></tr>");  
