<%-- 
    Document   : StartExam
    Created on : 22 Jul, 2025, 10:28:26 AM
    Author     : Piyush verma
--%>
    ...
    <center>
        ...
        <%
            ...
            if (db.rst.next()){
              ...
              int count=1;
            while(db.rst.next()){
                out.println("<tr style='color:white; background-color:dodgerblue'>"
                            +"<td colspan=2>Ques."+count+":&nbsp;"+db.rst.getString(2)+"</td></tr>");
            
                out.println("<tr><td width=400><input type=radio name=ans"+count+" value='"+db.rst.getString(3)+"'>"+db.rst.getString(3)+"</td>");
              out.println("<tr><td><input type=radio name=ans"+count+" value='"+db.rst.getString(4)+"'>"+db.rst.getString(4)+"</td></tr>");
               out.println("<tr><td width=400><input type=radio name=ans"+count+" value='"+db.rst.getString(5)+"'>"+db.rst.getString(5)+"</td>");
            out.println("<tr><td><input type=radio name =ans"+count+" value='"+db.rst.getString(6)+"'>"+db.rst.getString(6)+"</td></tr>");
