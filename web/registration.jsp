<%-- 
    ...
    Created on : 14 Jul, 2025, 12:05:12 PM
    Author     : Piyush verma
--%>
...
<form action="StuRegConf">
 <table class="content">
    <tr><td>Roll Number</td><td>Student Name:</td></tr>

    <tr><td><input type="number" name="rno"></td><td><input type="text" name="sname"></td></tr>
    <tr><td>D.O.B</td><td>Gender</td></tr>
    ...
    <tr><td>Address</td><td>Contact</td></tr>

    <tr><td><input type="text" name="addr"></td><td><input type="number" name="cont"></td></tr>
     

     <tr><td>E-Mail</td><td>User Name</td></tr>
     <tr><td><input type="email" name="email"></td><td><input type="text" name="user"></td></tr>
